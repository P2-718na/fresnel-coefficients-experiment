\subsection{Andamento dei coefficienti di Fresnel}\label{subsec:analisi-coefficienti}
  ...
  \begin{figure}[H]
    ...
    \begin{subfigure}[t]{.47\textwidth}
      \includegraphics[width=8.25cm]{./graphs/raw-pi.png}
      \caption{
        \emph{
    ...
    %
    \begin{subfigure}[t]{.47\textwidth}
      \includegraphics[width=8.25cm]{./graphs/raw-sigma.png}
      \caption{
        \emph{
  ...
  caratteristico per il vetro K9 alla lunghezza d'onda della luce rossa.}. % abbiamo anche aggiunto un range I_0 del 10%. è per far venire meglio il grafico.
  %
  \begin{figure}[H]
    \centering
    \begin{subfigure}[t]{.47\textwidth}
      \includegraphics[width=8.25cm]{./graphs/r-pi-coefficient.png}
      \caption{
        \emph{
    ...
    %
    \begin{subfigure}[t]{.47\textwidth}
      \includegraphics[width=8.25cm]{./graphs/r-sigma-coefficient.png}
      \caption{
        \emph{
...
\subsection{Misura dell'angolo di Brewster}\label{subsec:angolo-di-brewster}
  ...
  \begin{figure}[h]
    \centering
    \includegraphics[width=8.75cm]{./graphs/brewsters-angle.png}
    \caption{
      \emph{
