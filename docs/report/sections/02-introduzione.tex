...
$\theta_t$ sono gli angoli d'incidenza e rifrazione\footnote{La $t$ in $\theta_t$ sta per "trasmesso". Convenzionalmente, con
$\theta_r$ si indica l'angolo di riflessione.} del raggio luminoso.
