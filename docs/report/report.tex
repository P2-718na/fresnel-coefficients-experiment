...
\section{Appendice}\label{sec:appendice}
  \subsection{Calcolo incertezza strumentale}\label{subsec:calcolo-incertezza-strumentale}
    ...
    I valori $V_{temt}'$ e $V_{ref}'$ che otterremo saranno dati da (??): %todo add ref
    ...
    \noindent Dividento la (ref) per la (ref) troviamo il valore vero cercato $V_{temt}$.%todo add ref
